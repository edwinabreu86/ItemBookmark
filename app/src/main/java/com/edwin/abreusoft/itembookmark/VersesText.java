...
public class VersesText {
    ...
    public static final  String[][] OT_MOSES = {
            ...
            {"Levitico", "3:17", "Estatuto perpetuo será por vuestras edades, dondequiera que habitéis, que ninguna grosura ni ninguna sangre comeréis."},
            {"Levitico", "8:6", "Entonces Moisés hizo acercarse a Aarón y a sus hijos, y los lavó con agua."},
            {"Levitico", "18:5", "Por tanto, guardaréis mis estatutos y mis ordenanzas, los cuales haciendo el hombre, vivirá en ellos. Yo Jehová."},
            {"Levitico", "26:12", "y andaré entre vosotros, y yo seré vuestro Dios, y vosotros seréis mi pueblo."},
    ...
    public static final  String[][] OT_MIN_PROPHETS = {
            ...
            {"Jonas", "2:9", "Mas yo con voz de alabanza te ofreceré sacrificios; Pagaré lo que prometí. La salvación es de Jehová."},
